...
import { Sparkles, CheckCircle2, AlertTriangle, ThumbsUp, ExternalLink } from 'lucide-react';
 ...
 */
export default function AIAnalysis({ analysis, sourceUrl, source }) {
  if (!analysis) return null;
  const { summary, strengths = [], risks = [], recommendation } = analysis;
  const targetSourceUrl = sourceUrl || analysis.sourceUrl;
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.75rem', marginBottom: '1.25rem' }}>
        ...
        {targetSourceUrl && (
          ...
          >
            ...
            <span>Open Source ({source || 'Official Link'})</span>
          </a>
        )}
      </div>
