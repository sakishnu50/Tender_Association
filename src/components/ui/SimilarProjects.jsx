...
import { Building2, MapPin, Calendar, Tag, Briefcase, Globe } from 'lucide-react';

/**
 * Section 3 — Similar Past Projects
 * Props:
 *   projects – Array of { id, name, client, sector, country, location, status, completionDate, similarity, description }
 */
          ...
          return (
            <div key={proj.id} className="similar-card">
              ...
              <div className="similar-card-meta">
                ...
                <span><Globe     size={12} />{proj.country || 'India'}</span>
