    ...
    <div className="opp-header-card">
      ...
      <div className="opp-header-top">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.35rem' }}>
          <ScoreRing score={opportunity.aiScore || opportunity.overallScore} max={10} />
      ...
      <div className="opp-header-meta" style={{ paddingTop: '0.875rem', borderTop: '1px solid var(--border-color)' }}>
        ...
        <div className="opp-meta-item">
          ...
          <span className="opp-meta-value">{opportunity.country || 'India'}</span>
        </div>

        <div className="opp-meta-item">
          <span className="opp-meta-label">
            <ExternalLink size={11} style={{ display: 'inline', marginRight: '0.25rem' }} />
            Source
          </span>
          {opportunity.sourceUrl ? (
            ...
            >
              {opportunity.source} <ExternalLink size={10} />
            </a>
          ) : (
            <span className="opp-meta-value">{opportunity.source}</span>
          )}
        </div>
